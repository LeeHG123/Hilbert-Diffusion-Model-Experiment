...
from datasets.polynomials import QuarticDataset, SexticDataset, OcticDataset, MixedPolynomialDataset
...
def get_dataset(config):
    if config.data.modality == '1D':
        if config.data.dataset == "Quadratic":
            ...
            dataset = QuarticDataset(num_data=config.data.num_data,
                                  num_points=config.data.dimension,
                                  seed=42)
            test_dataset = QuarticDataset(num_data=config.data.num_data,
                                       num_points=config.data.dimension,
                                       seed=43)
        elif config.data.dataset == "Sextic":
            dataset = SexticDataset(num_data=config.data.num_data,
                                 num_points=config.data.dimension,
                                 seed=42)
            test_dataset = SexticDataset(num_data=config.data.num_data,
                                      num_points=config.data.dimension,
                                      seed=43)
        elif config.data.dataset == "Octic":
            dataset = OcticDataset(num_data=config.data.num_data,
                                num_points=config.data.dimension,
                                seed=42)
            test_dataset = OcticDataset(num_data=config.data.num_data,
                                     num_points=config.data.dimension,
                                     seed=43)
        elif config.data.dataset == "MixedPolynomial":
            dataset = MixedPolynomialDataset(num_data=config.data.num_data,
                                          num_points=config.data.dimension,
                                          seed=42)
            test_dataset = MixedPolynomialDataset(num_data=config.data.num_data,
                                               num_points=config.data.dimension,
                                               seed=43)
